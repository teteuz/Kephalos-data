...
logger = get_logger('kephalosdata.simulation')
...
class SimulationManager:
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                f"1. Activate conda environment: conda activate KephalosData\n"
                ...
                f"   - Parallel (both platforms): python {scripts_dir}/run_parallel_simulation.py --config {config_path}"
            )
        }
