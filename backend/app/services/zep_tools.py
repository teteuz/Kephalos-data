...
class PanoramaResult:
    ...
    def to_text(self) -> str:
        ...
        if self.historical_facts:
            text_parts.append(f"\n### [HISTORICAL FACTS] (evolution records)")
...
class ZepToolsService:
    ...
    def search_graph(
        ...
        try:
            ...
            logger.warning(f"Zep Search API failed, using local search: {str(e)}")
            # ：
    ...
    def get_node_detail(self, node_uuid: str) -> Optional[NodeInfo]:
        ...
        Returns:
            None
        """
        logger.info(f"Getting node: {node_uuid[:8]}...")
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        try:
            ...
            logger.info(f"Found {len(result)} node edges")
            return result
    ...
    def get_entity_summary(
        ...
        """
        logger.info(f"Getting summary for entity {entity_name}...")
    ...
    def get_graph_statistics(self, graph_id: str) -> Dict[str, Any]:
        ...
        """
        logger.info(f"Getting graph stats for {graph_id}...")
    ...
    def _generate_sub_queries(
        ...
        """
        system_prompt = """You are a professional question analysis expert. Decompose complex questions into sub-questions observable in the simulation.
...
JSON"""
    ...
    def interview_agents(
        ...
        if not profiles:
            logger.warning(f"No persona file for simulation {simulation_id}")
            result.summary = "No agent persona files found"
            return result
        
        result.total_agents = len(profiles)
        logger.info(f"Loaded {len(profiles)} personas")
        ...
        if not result.interview_questions:
            ...
            logger.info(f"Generated {len(result.interview_questions)} questions")
        ...
        try:
            ...
            if not api_result.get("success", False):
                ...
                result.summary = f"Interview API failed: {error_msg}. Check OASIS environment."
                return result
            ...
            result.summary = f"Interview failed: {str(e)}. Simulation environment may be closed."
            return result
        except Exception as e:
        ...
        logger.info(f"InterviewAgents complete: {result.interviewed_count} agents")
        return result
    ...
    def _select_agents_for_interview(
        ...
        system_prompt = """You are a professional interview planning expert. Select the most suitable agents from the simulation.
...
{max_agents}Agent，"""
    ...
    def _generate_interview_questions(
        ...
        system_prompt = """You are a professional journalist. Generate 3-5 in-depth interview questions.
...
3-5"""
    ...
    def _generate_interview_summary(
        ...
        system_prompt = """You are a professional news editor. Generate an interview summary based on interviewee responses.
