        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Fast chat mode for the report-generation agent with 4 specialist tools and complete MiroFish memory.</div>
              </div>
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews that run multi-turn parallel dialogs with simulated individuals to capture unstructured opinions and sentiment states.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent to dive deeper into report insights' : 'Chat with simulated individuals to understand their perspectives' }}
              </p>
            </div>
            <div 
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
 // : res.data.result.results targets
...
const submitSurvey = async () => {
  ...
  addLog(`Send survey to ${selectedAgents.value.size} targets...`)
